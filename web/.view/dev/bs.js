...
pug_html = pug_html + "\u003C\u002Fhead\u003E\u003Cbody\u003E\u003Cdiv class=\"w-1024 rwd mx-auto my-4\"\u003E\u003Ch3\u003EBSN Loading Test\u003C\u002Fh3\u003E\u003Cp\u003EBootstrap native is preloaded while we also use block to load. Both use different version so only the block loaded one will work.\u003C\u002Fp\u003E\u003Cdiv class=\"dropdown\"\u003E\u003Cdiv class=\"btn btn-light dropdown-toggle\" data-toggle=\"dropdown\"\u003EDropdown\u003C\u002Fdiv\u003E\u003Cdiv class=\"dropdown-menu\"\u003E\u003Cdiv class=\"dropdown-item\"\u003EItem 1\u003C\u002Fdiv\u003E\u003Cdiv class=\"dropdown-item\"\u003EItem 2\u003C\u002Fdiv\u003E\u003Cdiv class=\"dropdown-item\"\u003EItem 3\u003C\u002Fdiv\u003E\u003Cdiv class=\"dropdown-item\"\u003EItem 4\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
...
pug_html = pug_html + "\u003Cscript\u003Evar cls;BSN.Version=\"3.0.16\";console.log(BSN);cls=new block[\"class\"]({code:{script:function(){return{pkg:{name:\"sample\",version:\"1.0.0\",dependencies:[{url:\"\u002Fassets\u002Flib\u002Fbootstrap.native\u002Fmain\u002Fbootstrap-native-v4.min.js\"}]},init:function(n){var o;o=n.context;console.log(\"in block: \",o.BSN);return new o.BSN.Dropdown(ld$.find(\".dropdown\",0))}}}}});cls.create().then(function(n){console.log(\"attach block instance ... \");return n.attach()}).then(function(){return console.log(\"done.\")});\u003C\u002Fscript\u003E\u003C\u002Fbody\u003E\u003C\u002Fhtml\u003E";
