...
pug_html = pug_html + "\u003Cscript type=\"module\"\u003Evar scope,_ctx;scope=new rescope;scope.registry(function(e){var t,n,a,o;t=e.name,n=e.version,a=e.path,o=e.type;return\"\u002Fassets\u002Flib\u002F\"+t+\"\u002F\"+n+\"\u002F\"+a});_ctx=rescope.dualContext();scope.load([{name:\"ldpalettepicker\",version:\"main\",path:\"index.min.js\",async:false}],_ctx).then(function(e){var t;t=e.ldpp;console.log(_ctx);return scope.load([{name:\"ldpalettepicker\",version:\"main\",path:\"all.palettes.js\"}],_ctx).then(function(){return console.log(t.get(\"all\"))})});\u003C\u002Fscript\u003E\u003C\u002Fbody\u003E\u003C\u002Fhtml\u003E";
